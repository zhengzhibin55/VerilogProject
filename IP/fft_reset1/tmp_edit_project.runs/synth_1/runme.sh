...
HD_PWD='D:/FPGA/V_project/IP/fft_reset1/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_reset1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fft_reset1.tcl
