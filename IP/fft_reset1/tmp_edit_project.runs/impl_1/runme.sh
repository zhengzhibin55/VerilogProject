...
HD_PWD='D:/FPGA/V_project/IP/fft_reset1/tmp_edit_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_reset1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fft_reset1.tcl -notrace
