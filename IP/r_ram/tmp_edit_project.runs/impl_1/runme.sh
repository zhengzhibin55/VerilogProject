...
HD_PWD='D:/FPGA/V_project/IP/r_ram/tmp_edit_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log r_ram.vdi -applog -m64 -messageDb vivado.pb -mode batch -source r_ram.tcl -notrace
