...
HD_PWD='d:/fpga/v_project/ip/pinredistribution/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PinRedistribution.vds -m64 -mode batch -messageDb vivado.pb -notrace -source PinRedistribution.tcl
