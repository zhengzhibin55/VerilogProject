...
HD_PWD='D:/FPGA/V_project/IP/ad_fft/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ad_fft.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ad_fft.tcl
